    ...
    public class KafeVeri : DbContext
    {
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            modelBuilder
                ...
                .HasForeignKey(x => x.UrunId) // SiparisDetay'dan Urun'e referans veren ForeignKey'i UrunId'dir
                .WillCascadeOnDelete(false); // Urun silinirse bağlı olduğu SiparisDetay'ı otomatik silme
        }
